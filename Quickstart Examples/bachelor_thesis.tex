...
%--- STATEMENT ON AI / IZJAVA O UI ---------------------------------------------

% Default statement title may be changed by entering the argument here. / Zadani naslov izjave se može promijeniti zadavanjem argumenta.
\begin{statementonai}

  If you utilised artificial intelligence during the preparation of your thesis,
  please specify the technologies used, their versions, and the purpose of their use in this section.

  \paragraph{Reflections on the Use of Artificial Intelligence:}
  Briefly describe the extent of your own interventions and revisions to the generated content, and where applicable,
  provide an assessment of accuracy, identified limitations, or instances of hallucination observed in the artificial intelligence used.

  \paragraph{Statement on the Use of Artificial Intelligence:}
  I hereby confirm that artificial intelligence was used in accordance with
  the Policy on the Appropriate Use of Artificial Intelligence at the Faculty of Electrical Engineering and Computing
  during the preparation of this Bachelor's thesis,
  and that the artificial intelligence did not substitute my critical thinking or my original contribution.
